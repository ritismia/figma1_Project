...
<button class="buttonsplay">
  ...
  <a style={{color : "black",textDecoration:"none"}} href="#resources">Demo</a>
</button>
           <button className="btn-signup"><a style={{color : "white",textDecoration:"none"}} href="#pricing">Sign up</a></button>
        </div>
